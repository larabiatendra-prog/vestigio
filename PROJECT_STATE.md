...
**Fase:** Bloque 00 completado; siguiente: Bloque 01
...
- Repositorio público en `https://github.com/larabiatendra-prog/vestigio` con estructura de workspaces, documentos de gobierno, tooling (TypeScript estricto, ESLint, Prettier, Vitest) y CI mínima en verde sobre Windows.
